  ...
  return (
    <>
      ...
      <div className='flex flex-col items-center pt-4'>
        ...
        <button className='rounded-md bg-red-500 text-white text-xl pr-8 pl-8 pt-2 pb-2 mt-7 mb-2s font-bold'><a href="https://docs.google.com/document/d/1MmfmNcg0PPgnJOAHwK2r9C5ORuObfgPn/edit?usp=sharing&ouid=117289838927529336567&rtpof=true&sd=true">Check Resume</a></button>
      </div>
    </>
  )
}
